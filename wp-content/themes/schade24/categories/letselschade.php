	...
	<div class="row">
		...
		<div class="col-xs-12 col-sm-8">
			<div class="hidden-sm hidden-md hidden-lg">
				<a href=<?= site_url(); ?>/schade-melden" class="btnRoundLightBlue width310max width100per blueshadow">Schade Melden</a>
				<div class="sep20px">&nbsp;</div>
			</div>
		...
		<div class="col-xs-12 col-sm-4">
			<div class="hidden-xs">
				...
				<a href="<?= site_url(); ?>/schade/personinjury/1" class="btnRoundLightBlue width310max width100per blueshadow">Schade Melden</a>
			</div>
			<div class="sep20px">&nbsp;</div>
