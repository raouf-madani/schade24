	...
	<div class="row">
		...
		<div class="col-xs-12 col-sm-8">
			<div class="hidden-sm hidden-md hidden-lg">
				<a href="<?php site_url(); ?>/schade-melden" class="btnRoundLightBlue width310max width100per blueshadow">Schade Melden</a>
		...
		<div class="col-xs-12 col-sm-4">
			...
			<div class="sep20px">&nbsp;</div>
			 <?php $image= $category['second_column'];
				         if(!empty($image)):
				    ?>
			<img src="<?php echo $image; ?>/images/category/Bedrijfsongeval.svg" class="img-responsive" alt="" title="">
				<?php endif; ?>
		</div>
	</div>
	<div class="row">
