                            	...
                            	<div class="col-lg-12 col-md-12 col-sm-12">
                                    <div class="box box-primary">
                                        <div class="box-header">
											...
											<div class="pull-left">
												<h3 class="box-title">Aanpassen / wijzigen Klant</h3>
											</div>
											...
											<?
												$this->Pagemodel->getClientDetails($clientID);
											?>
											<? if($success) { ?>
											...
											<? } ?>   
											<form name="myPartnerRegister" id="myPartnerRegister" method="post" action="<?=site_url()?>page/editclientpartner/<?=$clientID?>">
												<input type="hidden" name="hdnAction" value="edit">	
												<input type="hidden" name="hdnID" value="<?=$clientID?>">
												<div class="formcls">
													<input type="text" name="txtName" class="form-control" placeholder="Naam" value="<?=$this->Pagemodel->txtName?>">
													<div class="sep20px">&nbsp;</div>
													<input type="text" name="txtEmail" class="form-control" placeholder="Emailadres" value="<?=$this->Pagemodel->txtEmail?>">
													<div class="sep20px">&nbsp;</div>
													<input type="text" name="txtPhone" class="form-control" placeholder="Telefoonnummer" value="<?=$this->Pagemodel->txtPhone?>">
													<div class="sep20px">&nbsp;</div>
